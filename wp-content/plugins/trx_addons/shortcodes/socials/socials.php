					...
					array(
						array(
							...
							"value" => apply_filters('trx_addons_sc_type', array(
								esc_html__('Only icons', 'trx_addons') => 'default',
								esc_html__('Only names', 'trx_addons') => 'names',
								esc_html__('Icon + name', 'trx_addons') => 'icons_names'
							), 'trx_sc_socials' ),
							"type" => "dropdown"
						),
						array(
										...
										$socials_type == 'images'
											? array(
													array(
														...
														"heading" => esc_html__("Select the uploaded icon", 'trx_addons'),
														"description" => wp_kses_data( __("Select the uploaded image to use it as social icon", 'trx_addons') ),
														"style" => $socials_type,
														"value" => $socials_type == 'images' 
																				? array_flip(trx_addons_get_list_files('css/socials', 'png'))
