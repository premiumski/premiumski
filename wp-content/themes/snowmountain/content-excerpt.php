...
?><article id="post-<?php the_ID(); ?>" 
	<?php post_class( 'post_item post_layout_excerpt post_format_'.esc_attr($snowmountain_post_format) ); ?>
	...
	// Featured image
	snowmountain_show_post_featured(array( 'thumb_size' => snowmountain_get_thumb_size( strpos(snowmountain_get_theme_option('body_style'), 'full')!==false ? 'full' : 'big' ) ));

	?>
    <div class="post_excerpt_content_wrap clearfix">
