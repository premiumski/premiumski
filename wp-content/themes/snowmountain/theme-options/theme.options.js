...
jQuery(document).ready(function() {
    ...
    //-----------------------------------------------------------------------------
    function snowmountain_override_option_start_check_dependencies() {
        jQuery( '.snowmountain_override_option .snowmountain_override_option_section' ).each(
            function () {
    ...
    jQuery( document ).ready( snowmountain_override_option_start_check_dependencies );
    // Check external dependencies (for example, "Page template" in the page edit mode)
    jQuery( window ).load( snowmountain_override_option_start_check_dependencies );
            ...
            function() {
                ...
                if (depend) {
                    ...
                    if (((dep_cnt > 0 || dep_all == 0) && dep_cmp == 'or') || (dep_cnt == dep_all && dep_cmp == 'and')) {
                        ctrl.parents( '.snowmountain_override_option_item' ).show().removeClass( 'snowmountain_override_option_no_use' );
                    } else {
                        ctrl.parents( '.snowmountain_override_option_item' ).hide().addClass( 'snowmountain_override_option_no_use' );
                    }
                }
