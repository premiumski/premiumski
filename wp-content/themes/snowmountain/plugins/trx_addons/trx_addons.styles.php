...
if (!function_exists('snowmountain_trx_addons_get_css')) {
	add_filter('snowmountain_filter_get_css', 'snowmountain_trx_addons_get_css', 10, 4);
	function snowmountain_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.breadcrumbs, .sc_item_subtitle,
.sc_action_item_default .sc_action_item_subtitle,
.sc_icons_item_title, .sc_skills_counter .sc_skills_total   {
...
.trx_addons_login_link .sc_layouts_item_details .sc_layouts_item_details_line1,
.trx_addons_login_link .sc_layouts_item_details .sc_layouts_item_details_line2 {
...
header.with_bg_image .sc_layouts_row_type_compact .sc_layouts_menu a:not(.sc_button),
header.with_bg_image .sc_layouts_row_type_compact .sc_layouts_item a:not(.sc_button),
header.with_bg_image .scheme_self.sc_layouts_row_type_compact .sc_layouts_menu a:not(.sc_button),
header.with_bg_image .scheme_self.sc_layouts_row_type_compact .sc_layouts_item a:not(.sc_button) {
	color: {$colors['inverse_text']};
}
...
.sc_layouts_row_type_compact .sc_layouts_item .sc_layouts_menu_mobile_button a:hover .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_compact .sc_layouts_item .sc_layouts_menu_mobile_button a:hover .sc_layouts_item_icon {
...
header.with_bg_image .sc_layouts_menu_nav > li > a:hover,
header.with_bg_image .sc_layouts_menu_nav > li.sfHover > a {
...
header.with_bg_image .sc_layouts_menu_nav > li.current-menu-item > a,
header.with_bg_image .sc_layouts_menu_nav > li.current-menu-parent > a,
header.with_bg_image .sc_layouts_menu_nav > li.current-menu-ancestor > a {
	color: {$colors['text_link']} !important;
}
...
.sc_action .swiper-pagination-custom .swiper-pagination-button.swiper-pagination-button-active,
.sc_action .slider_swiper .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet-active,
.sc_action .slider_swiper_outer .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet-active,
.sc_action .slider_swiper .slider_pagination_wrap .swiper-pagination-bullet:hover,
.sc_action .slider_swiper_outer .slider_pagination_wrap .swiper-pagination-bullet:hover {
...
.sc_action_item.with_image .sc_action_item_title {
	color:{$colors['inverse_text']};
}
/* Anchor */
...
.sc_services_list .sc_services_item_icon {
	color: {$colors['text_link_03']};
	border-color: {$colors['text_link']};
}
.sc_services_list .sc_services_item_link {
	color: {$colors['text_hover']};
}
.sc_services_list .sc_services_item_link:hover {
	color: {$colors['text_link']};
}
.sc_services_list .sc_button:not(.sc_button_simple) {
	color: {$colors['text_link']}!important;
}
.sc_services_list .sc_button:not(.sc_button_simple):hover {
	color: {$colors['text_hover']}!important;
}
...
.sc_services_light .sc_services_item:hover .sc_services_item_icon,
.sc_services_light .sc_services_item:hover .sc_services_item_title,
.sc_services_light .sc_services_item:hover .sc_services_item_title a {
	color: {$colors['inverse_text']};
}
...
.sc_services_default .sc_services_item_button a.sc_button_simple {
	color: {$colors['text_link']};
}
.sc_services_default .sc_services_item_button a.sc_button_simple:hover {
	color: {$colors['text_hover']}!important;
}
...
.sc_skills.sc_skills_pie .sc_skills_legend_title,
.sc_skills.sc_skills_pie .sc_skills_legend_value {
	color:{$colors['text_link']};
}
