...
if ( !function_exists( 'snowmountain_vc_get_css' ) ) {
	add_filter( 'snowmountain_filter_get_css', 'snowmountain_vc_get_css', 10, 4 );
	function snowmountain_vc_get_css($css, $colors, $fonts, $scheme='') {
...
.vc_tta.vc_tta-color-grey.vc_tta-style-classic .vc_tta-tab + .vc_tta-tab:before {
