...
if ( !function_exists( 'snowmountain_woocommerce_get_css' ) ) {
	add_filter( 'snowmountain_filter_get_css', 'snowmountain_woocommerce_get_css', 10, 4 );
	function snowmountain_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
/* Buttons */
.snowmountain_shop_mode_buttons a {
	color: {$colors['text_hover']};
}
.snowmountain_shop_mode_buttons a:hover,
.shop_mode_thumbs .snowmountain_shop_mode_buttons a.woocommerce_thumbs,
