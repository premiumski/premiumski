...
define( 'DB_NAME', 'buh8zh7gq6tl2vmitywt' );

/** Database username */
define( 'DB_USER', 'u7zppd1cda4ho0ka' );

/** Database password */
define( 'DB_PASSWORD', 'V6xsSuqbQzFs80aewSy' );

/** Database hostname */
define( 'DB_HOST', 'buh8zh7gq6tl2vmitywt-mysql.services.clever-cloud.com' );
