...
define( 'DB_NAME', 'b7xbjyy7aotrxhcyihun' );

/** Database username */
define( 'DB_USER', 'ub6filjlynwfftxz' );

/** Database password */
define( 'DB_PASSWORD', 'OZxRHBn66uzRMGd7cxP' );

/** Database hostname */
define( 'DB_HOST', 'b7xbjyy7aotrxhcyihun-mysql.services.clever-cloud.com' );
