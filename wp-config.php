...
define( 'DB_NAME', 'bw87zc1cmycevdxf2les' );

/** Database username */
define( 'DB_USER', 'uliqvkkcdf6jijuy' );

/** Database password */
define( 'DB_PASSWORD', 'sjo0t7RKNKORez0xjP8n' );

/** Database hostname */
define( 'DB_HOST', 'bw87zc1cmycevdxf2les-mysql.services.clever-cloud.com' );
