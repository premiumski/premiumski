...
define( 'DB_NAME', 'bmfb0tnsexuapq4vmqmv' );

/** Database username */
define( 'DB_USER', 'uz2anwbajgxlomqe' );

/** Database password */
define( 'DB_PASSWORD', 'YKKbyuQuL2Gvd5iW4iBx' );

/** Database hostname */
define( 'DB_HOST', 'bmfb0tnsexuapq4vmqmv-mysql.services.clever-cloud.com' );
