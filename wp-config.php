...
define( 'DB_NAME', 'bxqh9zildxkclklltfi0' );

/** Database username */
define( 'DB_USER', 'urn8o2myxowhjbbl' );

/** Database password */
define( 'DB_PASSWORD', '59bDM8FjYeP9db87px9J' );

/** Database hostname */
define( 'DB_HOST', 'bxqh9zildxkclklltfi0-mysql.services.clever-cloud.com' );
